...
namespace utils
{
	...
	extern buff_instance* is_recalling(game_object* hero);
	extern bool is_protected_by_spell_shield(game_object* hero);
	extern bool is_immune_to_cc(game_object* hero);
	extern bool is_invulnerable(game_object* hero);
